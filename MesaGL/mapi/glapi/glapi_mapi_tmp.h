...
void APIENTRY GLAPI_PREFIX(_dispatch_stub_832)(GLenum target, GLenum internalformat, GLenum pname, GLsizei bufSize, GLint *params);
...
void APIENTRY GLAPI_PREFIX(_dispatch_stub_863)(GLfloat x, GLfloat y, GLfloat z, GLfloat width, GLfloat height);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_864)(const GLfloat *coords);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_865)(GLint x, GLint y, GLint z, GLint width, GLint height);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_866)(const GLint *coords);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_867)(GLshort x, GLshort y, GLshort z, GLshort width, GLshort height);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_868)(const GLshort *coords);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_869)(GLfixed x, GLfixed y, GLfixed z, GLfixed width, GLfixed height);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_870)(const GLfixed *coords);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_871)(GLenum type, GLsizei stride, const GLvoid *pointer);
GLbitfield APIENTRY GLAPI_PREFIX(_dispatch_stub_872)(GLfixed *mantissa, GLint *exponent);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_873)(GLclampf value, GLboolean invert);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_874)(GLenum pattern);
...
void APIENTRY GLAPI_PREFIX(_dispatch_stub_881)(GLenum target, GLsizei numAttachments, const GLenum *attachments);
...
void APIENTRY GLAPI_PREFIX(_dispatch_stub_908)(const GLenum *mode, const GLint *first, const GLsizei *count, GLsizei primcount, GLint modestride);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_909)(const GLenum *mode, const GLsizei *count, GLenum type, const GLvoid * const *indices, GLsizei primcount, GLint modestride);
...
void APIENTRY GLAPI_PREFIX(_dispatch_stub_983)(GLenum face);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_984)(GLuint array);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_985)(GLsizei n, GLuint *arrays);
...
void APIENTRY GLAPI_PREFIX(_dispatch_stub_993)(GLenum coord, GLenum pname, GLfixed *params);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_994)(GLenum coord, GLenum pname, GLint param);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_995)(GLenum coord, GLenum pname, const GLfixed *params);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_996)(GLclampd zmin, GLclampd zmax);
...
void APIENTRY GLAPI_PREFIX(_dispatch_stub_999)(GLenum target, GLenum pname, GLint param);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_1000)(GLenum target, GLintptr offset, GLsizeiptr size);
...
void APIENTRY GLAPI_PREFIX(_dispatch_stub_1046)(GLenum frontfunc, GLenum backfunc, GLint ref, GLuint mask);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_1047)(GLenum target, GLuint index, GLsizei count, const GLfloat *params);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_1048)(GLenum target, GLuint index, GLsizei count, const GLfloat *params);
...
void APIENTRY GLAPI_PREFIX(_dispatch_stub_1051)(GLenum func, GLclampx ref);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_1052)(GLclampx red, GLclampx green, GLclampx blue, GLclampx alpha);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_1053)(GLclampx depth);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_1054)(GLfixed red, GLfixed green, GLfixed blue, GLfixed alpha);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_1055)(GLclampx zNear, GLclampx zFar);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_1056)(GLenum pname, GLfixed param);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_1057)(GLenum pname, const GLfixed *params);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_1058)(GLfloat left, GLfloat right, GLfloat bottom, GLfloat top, GLfloat zNear, GLfloat zFar);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_1059)(GLfixed left, GLfixed right, GLfixed bottom, GLfixed top, GLfixed zNear, GLfixed zFar);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_1060)(GLenum pname, GLfixed param);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_1061)(GLenum pname, const GLfixed *params);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_1062)(GLenum light, GLenum pname, GLfixed param);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_1063)(GLenum light, GLenum pname, const GLfixed *params);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_1064)(GLfixed width);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_1065)(const GLfixed *m);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_1066)(GLenum face, GLenum pname, GLfixed param);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_1067)(GLenum face, GLenum pname, const GLfixed *params);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_1068)(const GLfixed *m);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_1069)(GLenum target, GLfixed s, GLfixed t, GLfixed r, GLfixed q);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_1070)(GLfixed nx, GLfixed ny, GLfixed nz);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_1071)(GLfloat left, GLfloat right, GLfloat bottom, GLfloat top, GLfloat zNear, GLfloat zFar);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_1072)(GLfixed left, GLfixed right, GLfixed bottom, GLfixed top, GLfixed zNear, GLfixed zFar);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_1073)(GLfixed size);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_1074)(GLfixed factor, GLfixed units);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_1075)(GLfixed angle, GLfixed x, GLfixed y, GLfixed z);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_1076)(GLclampx value, GLboolean invert);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_1077)(GLfixed x, GLfixed y, GLfixed z);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_1078)(GLenum target, GLenum pname, GLfixed param);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_1079)(GLenum target, GLenum pname, const GLfixed *params);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_1080)(GLenum target, GLenum pname, GLfixed param);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_1081)(GLfixed x, GLfixed y, GLfixed z);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_1082)(GLenum plane, const GLfloat *equation);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_1083)(GLenum plane, const GLfixed *equation);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_1084)(GLenum plane, GLfloat *equation);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_1085)(GLenum plane, GLfixed *equation);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_1086)(GLenum pname, GLfixed *params);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_1087)(GLenum light, GLenum pname, GLfixed *params);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_1088)(GLenum face, GLenum pname, GLfixed *params);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_1089)(GLenum target, GLenum pname, GLfixed *params);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_1090)(GLenum target, GLenum pname, GLfixed *params);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_1091)(GLenum pname, GLfixed param);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_1092)(GLenum pname, const GLfixed *params);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_1093)(GLenum target, GLenum pname, const GLfixed *params);
