descriptor = [
    {
        ...
        "params": [
            ...
            [
                ...
                "CONTEXT_FLOAT2(Const.MinLineWidth), NO_EXTRA",
            ],
            ...
            [
                "MAX_TEXTURE_SIZE",
                "LOC_CUSTOM, TYPE_INT, offsetof(struct gl_context, Const.MaxTextureLevels), NO_EXTRA",
            ],
            ["MAX_VIEWPORT_DIMS", "CONTEXT_INT2(Const.MaxViewportWidth), NO_EXTRA"],
            ["PACK_ALIGNMENT", "CONTEXT_INT(Pack.Alignment), NO_EXTRA"],
            [
                "ALIASED_POINT_SIZE_RANGE",
                "CONTEXT_FLOAT2(Const.MinPointSize), NO_EXTRA",
            ],
            ...
            [
                ...
                "LOC_CUSTOM, TYPE_INT, TEXTURE_CUBE_INDEX, extra_ARB_texture_cube_map",
            ],
            # XXX: OES_texture_cube_map
            [
                "MAX_CUBE_MAP_TEXTURE_SIZE_ARB",
                "LOC_CUSTOM, TYPE_INT, offsetof(struct gl_context, Const.MaxCubeTextureLevels), extra_ARB_texture_cube_map",
            ],
            ...
            [
                ...
                "CONTEXT_ENUM(Color.Blend[0].EquationA), NO_EXTRA",
            ],
            ...
            [
                "SAMPLE_COVERAGE_ARB",
                "CONTEXT_BOOL(Multisample.SampleCoverage), NO_EXTRA",
            ],
            [
            ...
            [
                "SAMPLE_BUFFERS_ARB",
                "BUFFER_INT(Visual.sampleBuffers), extra_new_buffers",
            ],
            ["SAMPLES_ARB", "BUFFER_INT(Visual.samples), extra_new_buffers"],
            # GL_ARB_sample_shading
            [
                "MIN_SAMPLE_SHADING_VALUE_ARB",
                "CONTEXT_FLOAT(Multisample.MinSampleShadingValue), extra_gl40_ARB_sample_shading",
            ],
            # GL_SGIS_generate_mipmap
            [
                "GENERATE_MIPMAP_HINT_SGIS",
                "CONTEXT_ENUM(Hint.GenerateMipmap), NO_EXTRA",
            ],
            ...
            [
                "CLAMP_VERTEX_COLOR",
                "CONTEXT_ENUM(Light.ClampVertexColor), extra_ARB_color_buffer_float",
            ],
            [
                "CLAMP_FRAGMENT_COLOR",
                "CONTEXT_ENUM(Color.ClampFragmentColor), extra_ARB_color_buffer_float",
            ],
            [
                "CLAMP_READ_COLOR",
                "CONTEXT_ENUM(Color.ClampReadColor), extra_ARB_color_buffer_float_or_glcore",
            ],
            # GL_ARB_copy_buffer
            ...
            [
                ...
                "LOC_CUSTOM, TYPE_INT, 0, extra_new_buffers",
            ],
            [
            ...
            [
                ...
                "CONTEXT_INT(Const.MaxRenderbufferSize), NO_EXTRA",
            ],
            ...
            [
                ...
                "CONTEXT_FLOAT(Const.MaxTextureMaxAnisotropy), extra_EXT_texture_filter_anisotropic",
            ],
        ],
    },
    # Enums in OpenGL and GLES1
    {
        "apis": ["GL", "GLES", "GL_CORE"],
        "params": [
            ...
            [
                "CLIP_DISTANCE0",
                "CONTEXT_BIT0(Transform.ClipPlanesEnabled), extra_valid_clip_distance",
            ],
            [
                "CLIP_DISTANCE1",
                "CONTEXT_BIT1(Transform.ClipPlanesEnabled), extra_valid_clip_distance",
            ],
            [
                "CLIP_DISTANCE2",
                "CONTEXT_BIT2(Transform.ClipPlanesEnabled), extra_valid_clip_distance",
            ],
            [
                "CLIP_DISTANCE3",
                "CONTEXT_BIT3(Transform.ClipPlanesEnabled), extra_valid_clip_distance",
            ],
            [
                "CLIP_DISTANCE4",
                "CONTEXT_BIT4(Transform.ClipPlanesEnabled), extra_valid_clip_distance",
            ],
            [
                "CLIP_DISTANCE5",
                "CONTEXT_BIT5(Transform.ClipPlanesEnabled), extra_valid_clip_distance",
            ],
            [
                "CLIP_DISTANCE6",
                "CONTEXT_BIT6(Transform.ClipPlanesEnabled), extra_valid_clip_distance",
            ],
            [
                "CLIP_DISTANCE7",
            ...
            [
                "CURRENT_COLOR",
                "CONTEXT_FIELD(Current.Attrib[VERT_ATTRIB_COLOR0][0], TYPE_FLOATN_4), extra_flush_current",
            ],
            [
                "CURRENT_NORMAL",
                "CONTEXT_FIELD(Current.Attrib[VERT_ATTRIB_NORMAL][0], TYPE_FLOATN_3), extra_flush_current",
            ],
            [
                "CURRENT_TEXTURE_COORDS",
                "LOC_CUSTOM, TYPE_FLOAT_4, 0, extra_flush_current_valid_texture_unit",
            ],
            ...
            [
                ...
                "CONST(MAX_PROJECTION_STACK_DEPTH), NO_EXTRA",
            ],
            ...
            [
                ...
                "CONTEXT_FLOAT(Point.Threshold), NO_EXTRA",
            ],
            [
                "PROJECTION_MATRIX",
                "CONTEXT_MATRIX(ProjectionMatrixStack.Top), NO_EXTRA",
            ],
            [
            ...
            [
                "TEXTURE_STACK_DEPTH",
                "LOC_CUSTOM, TYPE_INT, 0, extra_valid_texture_unit",
            ],
            [
                "VERTEX_ARRAY",
                "ARRAY_BOOL(VertexAttrib[VERT_ATTRIB_POS].Enabled), NO_EXTRA",
            ],
            [
                "VERTEX_ARRAY_SIZE",
                "ARRAY_INT(VertexAttrib[VERT_ATTRIB_POS].Size), NO_EXTRA",
            ],
            [
                "VERTEX_ARRAY_TYPE",
                "ARRAY_ENUM(VertexAttrib[VERT_ATTRIB_POS].Type), NO_EXTRA",
            ],
            [
                "VERTEX_ARRAY_STRIDE",
                "ARRAY_INT(VertexAttrib[VERT_ATTRIB_POS].Stride), NO_EXTRA",
            ],
            [
                "NORMAL_ARRAY",
                "ARRAY_BOOL(VertexAttrib[VERT_ATTRIB_NORMAL].Enabled), NO_EXTRA",
            ],
            [
                "NORMAL_ARRAY_TYPE",
                "ARRAY_ENUM(VertexAttrib[VERT_ATTRIB_NORMAL].Type), NO_EXTRA",
            ],
            [
                "NORMAL_ARRAY_STRIDE",
            ...
            [
                "COLOR_ARRAY",
                "ARRAY_BOOL(VertexAttrib[VERT_ATTRIB_COLOR0].Enabled), NO_EXTRA",
            ],
            [
                "COLOR_ARRAY_SIZE",
                "ARRAY_INT(VertexAttrib[VERT_ATTRIB_COLOR0].Size), NO_EXTRA",
            ],
            [
                "COLOR_ARRAY_TYPE",
                "ARRAY_ENUM(VertexAttrib[VERT_ATTRIB_COLOR0].Type), NO_EXTRA",
            ],
            [
                "COLOR_ARRAY_STRIDE",
            ...
            [
                "TEXTURE_GEN_STR_OES",
                "LOC_TEXUNIT, TYPE_BIT_0, offsetof(struct gl_texture_unit, TexGenEnabled), NO_EXTRA",
            ],
            # GL_ARB_multisample
            ["MULTISAMPLE_ARB", "CONTEXT_BOOL(Multisample.Enabled), NO_EXTRA"],
            [
                "SAMPLE_ALPHA_TO_ONE_ARB",
                "CONTEXT_BOOL(Multisample.SampleAlphaToOne), NO_EXTRA",
            ],
            # GL_ARB_vertex_buffer_object
            [
                "VERTEX_ARRAY_BUFFER_BINDING_ARB",
                "LOC_CUSTOM, TYPE_INT, offsetof(struct gl_array_object, VertexBinding[VERT_ATTRIB_POS].BufferObj), NO_EXTRA",
            ],
            [
                "NORMAL_ARRAY_BUFFER_BINDING_ARB",
                "LOC_CUSTOM, TYPE_INT, offsetof(struct gl_array_object, VertexBinding[VERT_ATTRIB_NORMAL].BufferObj), NO_EXTRA",
            ],
            [
                "COLOR_ARRAY_BUFFER_BINDING_ARB",
                "LOC_CUSTOM, TYPE_INT, offsetof(struct gl_array_object, VertexBinding[VERT_ATTRIB_COLOR0].BufferObj), NO_EXTRA",
            ],
            [
                "TEXTURE_COORD_ARRAY_BUFFER_BINDING_ARB",
                "LOC_CUSTOM, TYPE_INT, NO_OFFSET, NO_EXTRA",
            ],
            # GL_OES_point_sprite
            [
                "POINT_SPRITE_NV",
                "CONTEXT_BOOL(Point.PointSprite), extra_NV_point_sprite_ARB_point_sprite",
            ],
        ],
    },
    {
    ...
    {
        "apis": ["GL", "GL_CORE", "GLES2"],
        "params": [
            # == GL_MAX_TEXTURE_COORDS_NV
            [
                "MAX_TEXTURE_COORDS_ARB",
                "CONTEXT_INT(Const.MaxTextureCoordUnits), extra_ARB_fragment_program",
            ],
            ...
            [
                ...
                "CONTEXT_INT(Const.MaxColorAttachments), NO_EXTRA",
            ],
            ...
            [
                "DRAW_BUFFER2_ARB",
                "BUFFER_ENUM(ColorDrawBuffer[2]), extra_valid_draw_buffer",
            ],
            [
                "DRAW_BUFFER3_ARB",
                "BUFFER_ENUM(ColorDrawBuffer[3]), extra_valid_draw_buffer",
            ],
            [
                "DRAW_BUFFER4_ARB",
                "BUFFER_ENUM(ColorDrawBuffer[4]), extra_valid_draw_buffer",
            ],
            [
                "DRAW_BUFFER5_ARB",
                "BUFFER_ENUM(ColorDrawBuffer[5]), extra_valid_draw_buffer",
            ],
            [
                "DRAW_BUFFER6_ARB",
                "BUFFER_ENUM(ColorDrawBuffer[6]), extra_valid_draw_buffer",
            ],
            [
                "DRAW_BUFFER7_ARB",
                "BUFFER_ENUM(ColorDrawBuffer[7]), extra_valid_draw_buffer",
            ],
            ...
            [
                ...
                "CONTEXT_INT(Const.Program[MESA_SHADER_FRAGMENT].MaxTextureImageUnits), extra_ARB_fragment_program",
            ],
            [
                "MAX_VERTEX_TEXTURE_IMAGE_UNITS_ARB",
                "CONTEXT_INT(Const.Program[MESA_SHADER_VERTEX].MaxTextureImageUnits), extra_ARB_vertex_shader",
            ],
            [
                "MAX_COMBINED_TEXTURE_IMAGE_UNITS_ARB",
                "CONTEXT_INT(Const.MaxCombinedTextureImageUnits), extra_ARB_vertex_shader",
            ],
            ...
            [
                ...
                "CONTEXT_ENUM(Stencil.ZFailFunc[1]), NO_EXTRA",
            ],
            [
                "STENCIL_BACK_PASS_DEPTH_PASS",
                "CONTEXT_ENUM(Stencil.ZPassFunc[1]), NO_EXTRA",
            ],
            [
                "MAX_VERTEX_ATTRIBS_ARB",
                "CONTEXT_INT(Const.Program[MESA_SHADER_VERTEX].MaxAttribs), extra_ARB_vertex_program_api_es2",
            ],
            # OES_texture_3D
            ["TEXTURE_BINDING_3D", "LOC_CUSTOM, TYPE_INT, TEXTURE_3D_INDEX, NO_EXTRA"],
            [
                "MAX_3D_TEXTURE_SIZE",
                "LOC_CUSTOM, TYPE_INT, offsetof(struct gl_context, Const.Max3DTextureLevels), NO_EXTRA",
            ],
            ...
            [
                "MAX_VARYING_VECTORS",
                "CONTEXT_INT(Const.MaxVarying), extra_ARB_ES2_compatibility_api_es2",
            ],
            [
                "MAX_VERTEX_UNIFORM_VECTORS",
                "LOC_CUSTOM, TYPE_INT, 0, extra_ARB_ES2_compatibility_api_es2",
            ],
            [
            ...
            [
                ...
                "CONST(0), extra_ARB_ES2_compatibility_api_es2",
            ],
            [
                "SHADER_BINARY_FORMATS",
                "LOC_CUSTOM, TYPE_INVALID, 0, extra_ARB_ES2_compatibility_api_es2",
            ],
    ...
    # GLES3 is not a typo.
    {
        "apis": ["GL", "GLES", "GLES3", "GL_CORE"],
        "params": [
            # GL_EXT_texture_lod_bias
            [
                "MAX_TEXTURE_LOD_BIAS_EXT",
                "CONTEXT_FLOAT(Const.MaxTextureLodBias), NO_EXTRA",
            ],
        ],
    },
    # Enums in  OpenGL and ES 3.0
    {
        ...
        "params": [
            ...
            [
                ...
                "CONTEXT_INT(Const.Program[MESA_SHADER_VERTEX].MaxOutputComponents), extra_gl32_es3",
            ],
            [
                "MAX_FRAGMENT_INPUT_COMPONENTS",
                "CONTEXT_INT(Const.Program[MESA_SHADER_FRAGMENT].MaxInputComponents), extra_gl32_es3",
            ],
            # GL_ARB_ES3_compatibility
            [
                "MAX_ELEMENT_INDEX",
                "CONTEXT_INT64(Const.MaxElementIndex), extra_ARB_ES3_compatibility_api_es3",
            ],
            # GL_ARB_fragment_shader
            [
                "MAX_FRAGMENT_UNIFORM_COMPONENTS_ARB",
                "CONTEXT_INT(Const.Program[MESA_SHADER_FRAGMENT].MaxUniformComponents), extra_ARB_fragment_shader",
            ],
            # GL_ARB_framebuffer_object
            [
                "MAX_SAMPLES",
                "CONTEXT_INT(Const.MaxSamples), extra_ARB_framebuffer_object_EXT_framebuffer_multisample",
            ],
            # GL_ARB_sync
            [
            ...
            [
                ...
                "CONTEXT_INT(Const.Program[MESA_SHADER_VERTEX].MaxUniformBlocks), extra_ARB_uniform_buffer_object",
            ],
            [
                "MAX_FRAGMENT_UNIFORM_BLOCKS",
                "CONTEXT_INT(Const.Program[MESA_SHADER_FRAGMENT].MaxUniformBlocks), extra_ARB_uniform_buffer_object",
            ],
            [
            ...
            [
                ...
                "CONTEXT_INT(Const.MaxUniformBlockSize), extra_ARB_uniform_buffer_object",
            ],
            [
            ...
            [
                ...
                "CONTEXT_INT(Const.Program[MESA_SHADER_VERTEX].MaxCombinedUniformComponents), extra_ARB_uniform_buffer_object",
            ],
            [
                "MAX_COMBINED_FRAGMENT_UNIFORM_COMPONENTS",
                "CONTEXT_INT(Const.Program[MESA_SHADER_FRAGMENT].MaxCombinedUniformComponents), extra_ARB_uniform_buffer_object",
            ],
            [
                "UNIFORM_BUFFER_OFFSET_ALIGNMENT",
                "CONTEXT_INT(Const.UniformBufferOffsetAlignment), extra_ARB_uniform_buffer_object",
            ],
            [
                "UNIFORM_BUFFER_BINDING",
                "LOC_CUSTOM, TYPE_INT, 0, extra_ARB_uniform_buffer_object",
            ],
            # GL_ARB_vertex_shader
            [
                "MAX_VERTEX_UNIFORM_COMPONENTS_ARB",
                "CONTEXT_INT(Const.Program[MESA_SHADER_VERTEX].MaxUniformComponents), extra_ARB_vertex_shader",
            ],
            [
                "MAX_VARYING_FLOATS_ARB",
                "LOC_CUSTOM, TYPE_INT, 0, extra_ARB_vertex_shader",
            ],
            ...
            [
                ...
                "CONTEXT_INT(Const.MinProgramTexelOffset), extra_GLSL_130_es3",
            ],
            [
                "MAX_PROGRAM_TEXEL_OFFSET",
                "CONTEXT_INT(Const.MaxProgramTexelOffset), extra_GLSL_130_es3",
            ],
            # GL_EXT_pixel_buffer_object
            [
                "PIXEL_PACK_BUFFER_BINDING_EXT",
                "LOC_CUSTOM, TYPE_INT, 0, extra_EXT_pixel_buffer_object",
            ],
            [
            ...
            [
                ...
                "LOC_CUSTOM, TYPE_INT, TEXTURE_2D_ARRAY_INDEX, extra_EXT_texture_array_es3",
            ],
            [
            ...
            [
                ...
                "LOC_CUSTOM, TYPE_INT, 0, extra_EXT_transform_feedback",
            ],
            [
                "RASTERIZER_DISCARD",
                "CONTEXT_BOOL(RasterDiscard), extra_EXT_transform_feedback",
            ],
            [
                "MAX_TRANSFORM_FEEDBACK_INTERLEAVED_COMPONENTS",
                "CONTEXT_INT(Const.MaxTransformFeedbackInterleavedComponents), extra_EXT_transform_feedback",
            ],
            [
    ...
    },
    {
        ...
        "params": [
            ...
            [
                ...
                "LOC_CUSTOM, TYPE_INT, TEXTURE_EXTERNAL_INDEX, extra_OES_EGL_image_external",
            ],
            [
                "TEXTURE_EXTERNAL_OES",
                "LOC_CUSTOM, TYPE_BOOLEAN, 0, extra_OES_EGL_image_external",
            ],
        ],
    },
    # Remaining enums are only in OpenGL
    {
        ...
        "params": [
            ...
            [
                "ACCUM_CLEAR_VALUE",
                "CONTEXT_FIELD(Accum.ClearColor[0], TYPE_FLOATN_4), NO_EXTRA",
            ],
            ...
            [
                ...
                "CONTEXT_ENUM(Light.ColorMaterialMode), NO_EXTRA",
            ],
            [
                "CURRENT_INDEX",
                "CONTEXT_FLOAT(Current.Attrib[VERT_ATTRIB_COLOR_INDEX][0]), extra_flush_current",
            ],
            [
            ...
            [
                ...
                "CONTEXT_FLOAT(Current.RasterDistance), NO_EXTRA",
            ],
            ["CURRENT_RASTER_INDEX", "CONST(1), NO_EXTRA"],
            [
                "CURRENT_RASTER_POSITION",
                "CONTEXT_FLOAT4(Current.RasterPos[0]), NO_EXTRA",
            ],
            [
            ...
            [
                ...
                "LOC_CUSTOM, TYPE_FLOAT_4, 0, extra_valid_texture_unit",
            ],
            [
                "CURRENT_RASTER_POSITION_VALID",
                "CONTEXT_BOOL(Current.RasterPosValid), NO_EXTRA",
            ],
            ...
            [
                ...
                "CONTEXT_ENUM(Light.Model.ColorControl), NO_EXTRA",
            ],
            [
                "LIGHT_MODEL_LOCAL_VIEWER",
                "CONTEXT_BOOL(Light.Model.LocalViewer), NO_EXTRA",
            ],
            ...
            [
                ...
                "CONTEXT_FLOAT(Const.LineWidthGranularity), NO_EXTRA",
            ],
            ...
            [
                ...
                "CONST(MAX_CLIENT_ATTRIB_STACK_DEPTH), NO_EXTRA",
            ],
            ...
            [
                ...
                "CONTEXT_FLOAT(Const.PointSizeGranularity), NO_EXTRA",
            ],
            ...
            [
                ...
                "LOC_CUSTOM, TYPE_INT, TEXTURE_1D_ARRAY_INDEX, extra_EXT_texture_array",
            ],
            [
                "TEXTURE_GEN_S",
                "LOC_TEXUNIT, TYPE_BIT_0, offsetof(struct gl_texture_unit, TexGenEnabled), NO_EXTRA",
            ...
            [
                "TEXTURE_GEN_T",
                "LOC_TEXUNIT, TYPE_BIT_1, offsetof(struct gl_texture_unit, TexGenEnabled), NO_EXTRA",
            ],
            [
                "TEXTURE_GEN_R",
                "LOC_TEXUNIT, TYPE_BIT_2, offsetof(struct gl_texture_unit, TexGenEnabled), NO_EXTRA",
            ],
            [
                "TEXTURE_GEN_Q",
                "LOC_TEXUNIT, TYPE_BIT_3, offsetof(struct gl_texture_unit, TexGenEnabled), NO_EXTRA",
            ],
            ...
            [
                ...
                "CONTEXT_INT(Hint.TextureCompression), NO_EXTRA",
            ],
            ...
            [
                ...
                "CONTEXT_FIELD(Current.Attrib[VERT_ATTRIB_COLOR1][0], TYPE_FLOATN_4), extra_flush_current",
            ],
            [
            ...
            [
                ...
                "ARRAY_BOOL(VertexAttrib[VERT_ATTRIB_FOG].Enabled), NO_EXTRA",
            ],
            [
                "FOG_COORDINATE_ARRAY_TYPE",
                "ARRAY_ENUM(VertexAttrib[VERT_ATTRIB_FOG].Type), NO_EXTRA",
            ],
            [
                "FOG_COORDINATE_ARRAY_STRIDE",
                "ARRAY_INT(VertexAttrib[VERT_ATTRIB_FOG].Stride), NO_EXTRA",
            ],
            [
                "FOG_COORDINATE_SOURCE",
                "CONTEXT_ENUM(Fog.FogCoordinateSource), NO_EXTRA",
            ],
            # GL_NV_fog_distance
            [
                "FOG_DISTANCE_MODE_NV",
                "CONTEXT_ENUM(Fog.FogDistanceMode), extra_NV_fog_distance",
            ],
            ...
            [
                ...
                "CONTEXT_ENUM(Point.SpriteOrigin), extra_NV_point_sprite_ARB_point_sprite",
            ],
            ...
            [
                ...
                "CONTEXT_BOOL(Stencil.TestTwoSide), extra_EXT_stencil_two_side",
            ],
            ...
            [
                ...
                "CONTEXT_BOOL(Array.PrimitiveRestart), extra_NV_primitive_restart",
            ],
            [
                "PRIMITIVE_RESTART_INDEX_NV",
                "CONTEXT_INT(Array.RestartIndex), extra_NV_primitive_restart",
            ],
            # GL_ARB_vertex_buffer_object
            [
                "INDEX_ARRAY_BUFFER_BINDING_ARB",
                "LOC_CUSTOM, TYPE_INT, offsetof(struct gl_array_object, VertexBinding[VERT_ATTRIB_COLOR_INDEX].BufferObj), NO_EXTRA",
            ],
            [
                "EDGE_FLAG_ARRAY_BUFFER_BINDING_ARB",
                "LOC_CUSTOM, TYPE_INT, offsetof(struct gl_array_object, VertexBinding[VERT_ATTRIB_EDGEFLAG].BufferObj), NO_EXTRA",
            ],
            [
                "SECONDARY_COLOR_ARRAY_BUFFER_BINDING_ARB",
                "LOC_CUSTOM, TYPE_INT, offsetof(struct gl_array_object, VertexBinding[VERT_ATTRIB_COLOR1].BufferObj), NO_EXTRA",
            ],
            [
                "FOG_COORDINATE_ARRAY_BUFFER_BINDING_ARB",
                "LOC_CUSTOM, TYPE_INT, offsetof(struct gl_array_object, VertexBinding[VERT_ATTRIB_FOG].BufferObj), NO_EXTRA",
            ],
            # GL_ARB_vertex_program
            # == GL_VERTEX_PROGRAM_NV
            [
                "VERTEX_PROGRAM_ARB",
                "CONTEXT_BOOL(VertexProgram.Enabled), extra_ARB_vertex_program",
            ],
            # == GL_VERTEX_PROGRAM_POINT_SIZE_NV
            [
                "VERTEX_PROGRAM_POINT_SIZE_ARB",
                "CONTEXT_BOOL(VertexProgram.PointSizeEnabled), extra_ARB_vertex_program",
            ],
            ...
            [
                ...
                "CONTEXT_INT(Const.MaxProgramMatrices), extra_ARB_vertex_program_ARB_fragment_program",
            ],
            # == GL_CURRENT_MATRIX_STACK_DEPTH_NV
            [
                "CURRENT_MATRIX_STACK_DEPTH_ARB",
                "LOC_CUSTOM, TYPE_INT, 0, extra_ARB_vertex_program_ARB_fragment_program",
            ],
            # == GL_CURRENT_MATRIX_NV
            [
                "CURRENT_MATRIX_ARB",
                "LOC_CUSTOM, TYPE_MATRIX, 0, extra_ARB_vertex_program_ARB_fragment_program",
            ],
            # == GL_CURRENT_MATRIX_NV
            [
            ...
            [
                ...
                "CONTEXT_INT(Program.ErrorPos), extra_ARB_vertex_program_ARB_fragment_program",
            ],
            # GL_ARB_fragment_program
            [
                "FRAGMENT_PROGRAM_ARB",
                "CONTEXT_BOOL(FragmentProgram.Enabled), extra_ARB_fragment_program",
            ],
            # GL_EXT_packed_float
            [
                "RGBA_SIGNED_COMPONENTS_EXT",
                "LOC_CUSTOM, TYPE_INT_4, 0, extra_EXT_packed_float",
            ],
            # GL_EXT_depth_bounds_test
            [
                "DEPTH_BOUNDS_TEST_EXT",
                "CONTEXT_BOOL(Depth.BoundsTest), extra_EXT_depth_bounds_test",
            ],
            [
                "DEPTH_BOUNDS_EXT",
                "CONTEXT_FLOAT2(Depth.BoundsMin), extra_EXT_depth_bounds_test",
            ],
            # GL_ARB_depth_clamp
            [
                "DEPTH_CLAMP",
                "CONTEXT_BOOL(Transform.DepthClamp), extra_ARB_depth_clamp",
            ],
            ...
            [
                ...
                "BUFFER_BOOL(_IntegerColor), extra_EXT_texture_integer_and_new_buffers",
            ],
            ...
            [
                "MAX_VERTEX_STREAMS",
                "CONTEXT_INT(Const.MaxVertexStreams), extra_ARB_transform_feedback3",
            ],
            # GL_ARB_geometry_shader4
            [
                "MAX_GEOMETRY_TEXTURE_IMAGE_UNITS_ARB",
                "CONTEXT_INT(Const.Program[MESA_SHADER_GEOMETRY].MaxTextureImageUnits), extra_gl32_ARB_geometry_shader4",
            ],
            [
            ...
            [
                ...
                "CONTEXT_INT(Const.MaxGeometryTotalOutputComponents), extra_gl32_ARB_geometry_shader4",
            ],
            [
                "MAX_GEOMETRY_UNIFORM_COMPONENTS_ARB",
                "CONTEXT_INT(Const.Program[MESA_SHADER_GEOMETRY].MaxUniformComponents), extra_gl32_ARB_geometry_shader4",
            ],
            [
                "MAX_GEOMETRY_VARYING_COMPONENTS_ARB",
                "CONTEXT_INT(Const.Program[MESA_SHADER_GEOMETRY].MaxOutputComponents), extra_ARB_geometry_shader4",
            ],
            [
                "MAX_VERTEX_VARYING_COMPONENTS_ARB",
                "CONTEXT_INT(Const.Program[MESA_SHADER_VERTEX].MaxOutputComponents), extra_ARB_geometry_shader4",
            ],
            # GL_ARB_color_buffer_float
            [
                "RGBA_FLOAT_MODE_ARB",
                "BUFFER_FIELD(Visual.floatMode, TYPE_BOOLEAN), extra_core_ARB_color_buffer_float_and_new_buffers",
            ],
            # GL_ARB_texture_buffer_object
            [
                "MAX_TEXTURE_BUFFER_SIZE_ARB",
                "CONTEXT_INT(Const.MaxTextureBufferSize), extra_texture_buffer_object",
            ],
            [
                "TEXTURE_BINDING_BUFFER_ARB",
                "LOC_CUSTOM, TYPE_INT, 0, extra_texture_buffer_object",
            ],
            [
                "TEXTURE_BUFFER_DATA_STORE_BINDING_ARB",
                "LOC_CUSTOM, TYPE_INT, TEXTURE_BUFFER_INDEX, extra_texture_buffer_object",
            ],
            [
            ...
            [
                ...
                "LOC_CUSTOM, TYPE_INT, TEXTURE_2D_MULTISAMPLE_INDEX, extra_ARB_texture_multisample",
            ],
            [
                "TEXTURE_BINDING_2D_MULTISAMPLE_ARRAY",
                "LOC_CUSTOM, TYPE_INT, TEXTURE_2D_MULTISAMPLE_ARRAY_INDEX, extra_ARB_texture_multisample",
            ],
            [
            ...
            [
                "SAMPLE_MASK",
                "CONTEXT_BOOL(Multisample.SampleMask), extra_ARB_texture_multisample",
            ],
            ...
            [
                ...
                "CONTEXT_BOOL(Color.sRGBEnabled), extra_EXT_framebuffer_sRGB",
            ],
            [
            ...
            [
                "PRIMITIVE_RESTART",
                "CONTEXT_BOOL(Array.PrimitiveRestart), extra_version_31",
            ],
            [
                "PRIMITIVE_RESTART_INDEX",
                "CONTEXT_INT(Array.RestartIndex), extra_version_31",
            ],
            # GL 3.2
            [
            ...
            [
                ...
                "CONST(MAX_DEBUG_GROUP_STACK_DEPTH), NO_EXTRA",
            ],
            ...
            [
                ...
                "CONTEXT_INT(Const.Program[MESA_SHADER_GEOMETRY].MaxUniformBlocks), extra_ARB_uniform_buffer_object_and_geometry_shader",
            ],
            [
                "MAX_COMBINED_GEOMETRY_UNIFORM_COMPONENTS",
                "CONTEXT_INT(Const.Program[MESA_SHADER_GEOMETRY].MaxCombinedUniformComponents), extra_ARB_uniform_buffer_object_and_geometry_shader",
            ],
            # GL_ARB_timer_query
            ...
            [
                ...
                "CONTEXT_INT(Const.MinMapBufferAlignment), NO_EXTRA",
            ],
            # GL_ARB_texture_cube_map_array
            [
                "TEXTURE_BINDING_CUBE_MAP_ARRAY_ARB",
                "LOC_CUSTOM, TYPE_INT, TEXTURE_CUBE_ARRAY_INDEX, extra_ARB_texture_cube_map_array",
            ],
            ...
            [
                ...
                "CONTEXT_INT(Const.Program[MESA_SHADER_VERTEX].MaxAtomicBuffers), extra_ARB_shader_atomic_counters",
            ],
            [
                "MAX_VERTEX_ATOMIC_COUNTERS",
                "CONTEXT_INT(Const.Program[MESA_SHADER_VERTEX].MaxAtomicCounters), extra_ARB_shader_atomic_counters",
            ],
            [
                "MAX_FRAGMENT_ATOMIC_COUNTER_BUFFERS",
                "CONTEXT_INT(Const.Program[MESA_SHADER_FRAGMENT].MaxAtomicBuffers), extra_ARB_shader_atomic_counters",
            ],
            [
                "MAX_FRAGMENT_ATOMIC_COUNTERS",
                "CONTEXT_INT(Const.Program[MESA_SHADER_FRAGMENT].MaxAtomicCounters), extra_ARB_shader_atomic_counters",
            ],
            [
                "MAX_GEOMETRY_ATOMIC_COUNTER_BUFFERS",
                "CONTEXT_INT(Const.Program[MESA_SHADER_GEOMETRY].MaxAtomicBuffers), extra_ARB_shader_atomic_counters_and_geometry_shader",
            ],
            [
                "MAX_GEOMETRY_ATOMIC_COUNTERS",
                "CONTEXT_INT(Const.Program[MESA_SHADER_GEOMETRY].MaxAtomicCounters), extra_ARB_shader_atomic_counters_and_geometry_shader",
            ],
            [
            ...
            [
                ...
                "CONTEXT_INT(Const.MaxCombinedAtomicCounters), extra_ARB_shader_atomic_counters",
            ],
            ...
            [
                "MAX_IMAGE_UNITS",
                "CONTEXT_INT(Const.MaxImageUnits), extra_ARB_shader_image_load_store",
            ],
            [
                "MAX_COMBINED_IMAGE_UNITS_AND_FRAGMENT_OUTPUTS",
                "CONTEXT_INT(Const.MaxCombinedImageUnitsAndFragmentOutputs), extra_ARB_shader_image_load_store",
            ],
            [
                "MAX_IMAGE_SAMPLES",
                "CONTEXT_INT(Const.MaxImageSamples), extra_ARB_shader_image_load_store",
            ],
            [
                "MAX_VERTEX_IMAGE_UNIFORMS",
                "CONTEXT_INT(Const.Program[MESA_SHADER_VERTEX].MaxImageUniforms), extra_ARB_shader_image_load_store",
            ],
            [
                "MAX_GEOMETRY_IMAGE_UNIFORMS",
                "CONTEXT_INT(Const.Program[MESA_SHADER_GEOMETRY].MaxImageUniforms), extra_ARB_shader_image_load_store_and_geometry_shader",
            ],
            [
                "MAX_FRAGMENT_IMAGE_UNIFORMS",
                "CONTEXT_INT(Const.Program[MESA_SHADER_FRAGMENT].MaxImageUniforms), extra_ARB_shader_image_load_store",
            ],
            [
    ...
    # Enums restricted to OpenGL Core profile
    {
        ...
        "params": [
            ...
            [
                ...
                "LOC_CUSTOM, TYPE_INT, 0, extra_ARB_draw_indirect",
            ],
            # GL_ARB_viewport_array
            [
                "MAX_VIEWPORTS",
                "CONTEXT_INT(Const.MaxViewports), extra_ARB_viewport_array",
            ],
            [
            ...
            [
                ...
                "CONTEXT_FLOAT2(Const.ViewportBounds), extra_ARB_viewport_array",
            ],
            [
